...
" `CBOR` varchar(6) NOT NULL,"
" `CNAER` varchar(3) NOT NULL,"
" `VINCPREV` varchar(1) NOT NULL,"
" `GESTOR_COD` varchar(5) NOT NULL,"
" `GESTOR_TP` varchar(1) NOT NULL,"
" `GESTOR_CPF` varchar(15) NOT NULL,"
...
" `RACA_COR` varchar(2) NOT NULL,"
" `ETNIA` varchar(4) NOT NULL,"
" `SEQUENCIA` int NOT NULL,"
" `REMESSA` varchar(21) NOT NULL,"
" `AUD_JUST` varchar(50) NOT NULL,"
" `SIS_JUST` varchar(50) NOT NULL,"
" `VAL_SH_FED` float NOT NULL,"
" `VAL_SP_FED` float NOT NULL,"
" `VAL_SH_GES` float NOT NULL,"
" `VAL_SP_GES` float NOT NULL,"
" `VAL_UCI` float NOT NULL,"
